...
from ngmix.gmix.gmix_nb import gmix_set_norms, gmix_eval_pixel_fast
from ngmix.gmix import GMixModel
from ngmix.shape import e1e2_to_g1g2
from ngmix.moments import mom2g, get_Tround
...
def check_exp(obs, psf_res, safe_factor=2):
    ...
    pars = [0, 0, g1_psf, g2_psf, safe_factor*psf_res[3], 1.]
